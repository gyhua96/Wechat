        ...
        Platform.runLater(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    new UDPClient().sendMsg(msg,new InetSocketAddress(user.getIp(),user.getPort()));
    ...
    class msgView extends ListCell<Messages>{
        protected void updateItem(Messages item, boolean empty) {
            ...
            if(item!=null){
                ...
                Image image=new Image("/images/pic.png", 50, 50, true, true);
                pic.setImage(image);
                VBox vBox=new VBox();
    ...
    class User extends ListCell<UserInfo> {
        ...
        protected void updateItem(UserInfo item, boolean empty) {
            ...
            if (item != null) {
                ...
                Image pic = new Image("/images/pic.png", 50, 50, true, true);
