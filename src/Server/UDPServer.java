...
public class UDPServer extends Config{
    private  DatagramChannel serverChannel;
    private Selector selector;
    private int serverPort;
    //private int UDPServerPort=8089;
    public UDPServer(int serverPort) throws Exception {
        ...
        while(selector.select()>0){
            ...
            while (it.hasNext()) {
                ...
                if(key.isReadable()){
                    ...
                    */
                    String msg=TCPServer.byteBufferToString(buf);
